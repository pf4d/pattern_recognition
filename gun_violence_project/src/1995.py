...
varis = {1   : {"name" : "ICPSR STUDY NUMBER",
         ...
         22  : {"name" : "SITUATION: VICTIMS AND OFFENDERS IN HOMICIDE",
                "type" : int},
         23  : {"name" : "AGE OF VICTIM - FIRST VICTIM",
                "type" : int},
         24  : {"name" : "GENDER OF VICTIM - FIRST VICTIM",
                "type" : int},
         25  : {"name" : "RACE OF VICTIM - FIRST VICTIM",
                "type" : int},
         26  : {"name" : "ETHNIC ORIGIN OF VICTIM - FIRST VICTIM",
                "type" : int},
         27  : {"name" : "AGE OF OFFENDER - FIRST OFFENDER",
                "type" : int},
         28  : {"name" : "GENDER OF OFFENDER - FIRST OFFENDER",
                "type" : int},
         29  : {"name" : "RACE OF OFFENDER - FIRST OFFENDER",
                "type" : int},
         30  : {"name" : "ETHNIC ORIGIN OF OFFENDER - FIRST OFFENDER",
                "type" : int},
         31  : {"name" : "WEAPON - FIRST OFFENDER",
                "type" : int},
         32  : {"name" : "RELATIONSHIP OF VICTIM TO OFFENDER - FIRST OFFENDER",
                "type" : int},
         33  : {"name" : "CIRCUMSTANCES SURROUNDING HOMICIDE - FIRST OFFENDER",
                "type" : int},
         34  : {"name" : "SUB-CIRCUMSTANCES: JUSTIFIABLE HOMICIDES - FIRST OFFENDER",
                "type" : int},
         35  : {"name" : "VICTIM COUNT",
                "type" : int},
         36  : {"name" : "OFFENDER COUNT",
                "type" : int},
         37  : {"name" : "AGE OF VICTIM - SECOND VICTIM",
                "type" : int},
         38  : {"name" : "GENDER OF VICTIM - SECOND VICTIM",
                "type" : int},
         39  : {"name" : "RACE OF VICTIM - SECOND VICTIM",
                "type" : int},
         40  : {"name" : "ETHNIC ORIGIN OF VICTIM - SECOND VICTIM",
                "type" : int},
         41  : {"name" : "AGE OF VICTIM - THIRD VICTIM",
                "type" : int},
         42  : {"name" : "GENDER OF VICTIM - THIRD VICTIM",
                "type" : int},
         43  : {"name" : "RACE OF VICTIM - THIRD VICTIM",
                "type" : int},
         44  : {"name" : "ETHNIC ORIGIN OF VICTIM - THIRD VICTIM",
                "type" : int},
         45  : {"name" : "AGE OF VICTIM - FOURTH VICTIM",
                "type" : int},
         46  : {"name" : "GENDER OF VICTIM - FOURTH VICTIM",
                "type" : int},
         47  : {"name" : "RACE OF VICTIM - FOURTH VICTIM",
                "type" : int},
         48  : {"name" : "ETHNIC ORIGIN OF VICTIM - FOURTH VICTIM",
                "type" : int},
         49  : {"name" : "AGE OF VICTIM - FIFTH VICTIM",
                "type" : int},
         50  : {"name" : "GENDER OF VICTIM - FIFTH VICTIM",
                "type" : int},
         51  : {"name" : "RACE OF VICTIM - FIFTH VICTIM",
                "type" : int},
         52  : {"name" : "ETHNIC ORIGIN OF VICTIM - FIFTH VICTIM",
                "type" : int},
         53  : {"name" : "AGE OF VICTIM - SIXTH VICTIM",
                "type" : int},
         54  : {"name" : "GENDER OF VICTIM - SIXTH VICTIM",
                "type" : int},
         55  : {"name" : "RACE OF VICTIM - SIXTH VICTIM",
                "type" : int},
         56  : {"name" : "ETHNIC ORIGIN OF VICTIM - SIXTH VICTIM",
                "type" : int},
         57  : {"name" : "AGE OF VICTIM - SEVENTH VICTIM",
                "type" : int},
         58  : {"name" : "GENDER OF VICTIM - SEVENTH VICTIM",
                "type" : int},
         59  : {"name" : "RACE OF VICTIM - SEVENTH VICTIM",
                "type" : int},
         60  : {"name" : "ETHNIC ORIGIN OF VICTIM - SEVENTH VICTIM",
                "type" : int},
         61  : {"name" : "AGE OF VICTIM - EIGHTH VICTIM",
                "type" : int},
         62  : {"name" : "GENDER OF VICTIM - EIGHTH VICTIM",
                "type" : int},
         63  : {"name" : "RACE OF VICTIM - EIGHTH VICTIM",
                "type" : int},
         64  : {"name" : "ETHNIC ORIGIN OF VICTIM - EIGHTH VICTIM",
                "type" : int},
         65  : {"name" : "AGE OF VICTIM - NINTH VICTIM",
                "type" : int},
         66  : {"name" : "GENDER OF VICTIM - NINTH VICTIM",
                "type" : int},
         67  : {"name" : "RACE OF VICTIM - NINTH VICTIM",
                "type" : int},
         68  : {"name" : "ETHNIC ORIGIN OF VICTIM - NINTH VICTIM",
                "type" : int},
         69  : {"name" : "AGE OF VICTIM - TENTH VICTIM",
                "type" : int},
         70  : {"name" : "GENDER OF VICTIM - TENTH VICTIM",
                "type" : int},
         71  : {"name" : "RACE OF VICTIM - TENTH VICTIM",
                "type" : int},
         72  : {"name" : "ETHNIC ORIGIN OF VICTIM - TENTH VICTIM",
                "type" : int},
         73  : {"name" : "AGE OF VICTIM - ELEVENTH VICTIM",
                "type" : int},
         74  : {"name" : "GENDER OF VICTIM - ELEVENTH VICTIM",
                "type" : int},
         75  : {"name" : "RACE OF VICTIM - ELEVENTH VICTIM",
                "type" : int},
         76  : {"name" : "ETHNIC ORIGIN OF VICTIM - ELEVENTH VICTIM",
                "type" : int},
...
data = open('../data/SHC/1995/ICPSR_09028/DS0089/09028-0089-Data.txt')

wid = [4,1,2,5,1,2,7,2,1,2,9,3,3,1,24,6,2,6,1,1,3,1,
       3,1,1,1,
       3,1,1,1,2,2,2,1,
       3,3,
       3,1,1,1,
